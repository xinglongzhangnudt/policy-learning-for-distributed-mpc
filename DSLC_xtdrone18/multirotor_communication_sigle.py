...
class Sigle_Communication:
    ...
    def construct_target(self, x=0, y=0, z=0, vx=0, vy=0, vz=0, afx=0, afy=0, afz=0, yaw=0, yaw_rate=0):
        ...
        if(self.motion_type == 0):                              #0:ignore v,a and yaw rate
...
if __name__ == '__main__':
    sigle_communication = Sigle_Communication(sys.argv[1],sys.argv[2])
    sigle_communication.start()
