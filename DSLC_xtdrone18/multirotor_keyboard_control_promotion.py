...
if __name__=="__main__":
    ...
    if multirotor_num == 18:
        formation_configs = ['origin', 'doubleorigin','cuboid', 'sphere', 'diamond']
    elif multirotor_num == 9:
        formation_configs = ['waiting', 'cube', 'pyramid', 'triangle','origin']
    elif multirotor_num == 6:
        formation_configs = ['origin', 'doubleorigin','T', 'diamond', 'triangle']
